    ...
    topics: [
      {
        ...
        completionDate: null,
        notes: '',
        subtopics: [          { id: 'linux-1-1', title: 'File System Navigation', status: 'not-started', resources: ['https://www.digitalocean.com/community/tutorials/basic-linux-navigation-and-file-management', 'https://linuxcommand.org/lc3_lts0020.php', 'https://www.redhat.com/sysadmin/navigating-filesystem-linux-terminal', 'https://www.guru99.com/linux-commands-cheat-sheet.html', 'https://www.tecmint.com/linux-file-system-explained/'] },
          { id: 'linux-1-2', title: 'Text Manipulation Commands', status: 'not-started', resources: ['https://www.geeksforgeeks.org/linux-commands/', 'https://www.digitalocean.com/community/tutorials/working-with-files-in-linux', 'https://linuxize.com/post/linux-text-manipulation-commands/', 'https://www.tecmint.com/linux-text-processing-commands/', 'https://www.redhat.com/sysadmin/linux-text-commands'] },
          { id: 'linux-1-3', title: 'I/O Redirection', status: 'not-started', resources: ['https://www.digitalocean.com/community/tutorials/an-introduction-to-linux-i-o-redirection', 'https://linuxcommand.org/lc3_lts0070.php', 'https://www.geeksforgeeks.org/input-output-redirection-in-linux/', 'https://www.tutorialspoint.com/unix/unix-io-redirections.htm', 'https://tldp.org/LDP/abs/html/io-redirection.html'] },
          { id: 'linux-1-4', title: 'Pipes and Filters', status: 'not-started', resources: ['https://www.geeksforgeeks.org/piping-in-unix-or-linux/', 'https://linuxcommand.org/lc3_lts0080.php', 'https://www.digitalocean.com/community/tutorials/an-introduction-to-linux-pipes-and-filters', 'https://www.tutorialspoint.com/unix/unix-pipes-filters.htm', 'https://www.redhat.com/sysadmin/pipes-command-line-linux'] },
          { id: 'linux-1-5', title: 'File Management Commands', status: 'not-started', resources: ['https://linuxize.com/post/basic-linux-commands/', 'https://www.digitalocean.com/community/tutorials/linux-commands', 'https://www.tecmint.com/basic-linux-commands/', 'https://www.guru99.com/must-know-linux-commands.html', 'https://www.freecodecamp.org/news/linux-command-line-tutorial/'] },
